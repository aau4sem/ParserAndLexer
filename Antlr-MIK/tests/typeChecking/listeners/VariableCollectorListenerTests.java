...
public class VariableCollectorListenerTests {
    ...
    public void intDcl05(){
        lexer = new TacticLexer(new ANTLRInputStream("int x = 5 + 5;"));
        parser = new Tactic(new CommonTokenStream(lexer));
        VariableCollectorListener vcl = new VariableCollectorListener();
        parser.addParseListener(vcl);
        parser.prog();
    ...
    public void floatDcl03(){
        lexer = new TacticLexer(new ANTLRInputStream("float x = 5.5 + 5.5;"));
        parser = new Tactic(new CommonTokenStream(lexer));
        VariableCollectorListener vcl = new VariableCollectorListener();
        parser.addParseListener(vcl);
        parser.prog();
        ...
        //Does it have the right value?
        Assert.assertEquals(11, Float.parseFloat(varCon.getValue()),4);
    ...
    public void mixedDcl02(){
        lexer = new TacticLexer(new ANTLRInputStream("int x = 5; float x = 3 + 3;"));
        parser = new Tactic(new CommonTokenStream(lexer));
        VariableCollectorListener vcl = new VariableCollectorListener();
        parser.addParseListener(vcl);
        parser.prog();
